//Yiwei He yh9vhg 10/05/2021 AVLTree.h
...
private:
    ...
    void insert(const string& x,AVLNode*& rootNode);
    string pathTo(const string& x,AVLNode* rootNode)const;
    bool find(const string& x,AVLNode* rootNode)const;
    int numNodes(AVLNode* rootNode)const;
};
