//Yiwei He yh9vhg 10/04/2021 BinarySearchTree.h
...
private:
    ...
    void insert(const string& x,BinaryNode*& rootNode) ;
    bool find(const string& x,BinaryNode* rootNode)const;
    string pathTo(const string& x,BinaryNode* rootNode)const;
    int numNodes(BinaryNode* rootNode)const;
