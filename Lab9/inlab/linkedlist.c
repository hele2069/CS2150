// Yiwei He yh9vhg 11/16/2021 linkedlist.c
...
int main(){
	...
	do {
		...
		struct list_item* node = (list_item*) malloc(sizeof(list_item));
        node-> value = val;
        struct list_item* dummy = (list_item*) malloc(sizeof(list_item));
        struct list_item* temp = (list_item*) malloc(sizeof(list_item));
