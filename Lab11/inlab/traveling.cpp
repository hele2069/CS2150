// Yiwei He yh9vhg traveling.cpp 11/30/2021
...
void findMin(MiddleEarth& me, vector<string> dests);
...
/**
 * @class takes in MiddleEarth class. 
 * @exception exception. 
 */
void findMin(MiddleEarth& me, vector<string> dests){
    ...
    float newMin = computeDistance(me, dests[0], dests);
...
float computeDistance(MiddleEarth& me, const string& start, vector<string> dests) {
    ...
    distance += me.getDistance(dests[0], dests[dests.size()-1]);
    return distance;
}
